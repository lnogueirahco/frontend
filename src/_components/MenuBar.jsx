...
export default function MenuBar({isLoading, onSearch}) {
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="relative hidden sm:block">
                ...
                <input type="text" placeholder="Buscar chamado..." className="
                    bg-gray-900 border border-gray-700 rounded-xl 
                    pl-10 pr-4 py-2 w-60 md:w-64 text-white placeholder-gray-500
